...
#region Terrain Inspector
	...
	public static readonly float FILL_TEXTURE_SIZE_MAX = 400.0f;
	/// Maximum offset of a tile of the fill texture.
	public static readonly float FILL_TEXTURE_OFFSET_MAX = 400.0f;
	
	/// Minimum width of a texture.
	public static readonly float TEXTURE_WIDTH_MIN = 0.00001f;
	/// Maximum width of a texture.
	public static readonly float TEXTURE_WIDTH_MAX = 500.0f;
	/// Minimum height of a texture.
	public static readonly float TEXTURE_HEIGHT_MIN = 0.00001f;
	/// Maximum height of a texture.
	public static readonly float TEXTURE_HEIGHT_MAX = 300.0f;
	...
	public static readonly float GRASS_SIZE_MAX = 300.0f;
	...
	public static readonly float CONTROL_TEXTURE_SIZE = 350;
...
#region Terrain Scene
	...
	public static readonly int BRUSH_SIZE_MAX = 300;
...
#region Generator
	...
	public static readonly Vector2 INIT_GRASS_HEIGHT_RANGE = new Vector2(0, 100);
