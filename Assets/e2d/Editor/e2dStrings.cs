...
public class e2dStrings
{
	...
	{
#if HACK
		"Left-click to place a node.\nHold ctrl and click to append a node to the end of the curve.\nHold shift and click to delete a node. Hold ctrl as well to move the rest of the nodes towards the deleted one.\nHold alt and drag a node to move all node behind it.\nHold alt and shift then click two nodes to delete all nodes between them and add this nodes to cache.\n Hold alt and ctrl then click to add nodes form cache.",
#else
		"Left-click to place a node.\nHold ctrl and click to append a node to the end of the curve.\nHold shift and click to delete a node. Hold ctrl as well to move the rest of the nodes towards the deleted one.",
#endif
